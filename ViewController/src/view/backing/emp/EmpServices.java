...
public class EmpServices {
    ...
    /**
     *
     * @param dtoList List<EmployeeDto> 
    ...
    public void saveFinalEmployeeAndDeleteDraftEmployee(AppModuleImpl appModule, Row[] rows) throws ParseException, Exception {
        ...
        try {
            for (Row row : rows) {
                ...
                CommonService.deleteRowById(draftEmployeeVO, "ID",draftEmpId);
            }
    ...
    private void createEmployeeVO(ViewObject vo, Row draftRow) throws ParseException {
        ...
        if (!StringUtils.isEmpty(sDate)) {
            Date date = CommonService.convertStringToDate(sDate, "E MMM dd HH:mm:ss Z yyyy");
    ...
    public EmployeeDto createNewEmployee(String[] empl) throws ParseException {
        ...
        if (empl[5] != null && !StringUtils.isBlank(empl[5])) {
            Date date = CommonService.convertStringToDate(empl[5], "dd-MMM-yy");
